...
/*We can also implement our own sorting schema, suppose we want to
sort an array of string according to its length.
In order to do that we have to implement our own Less, Len and Swap methods
defined in the sort Interface.*/
